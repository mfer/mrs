...
public class approx extends PApplet {
...
public void drawLink( ArrayList<Link> links){
  for(Link l : links){
    int id = l.id;
...
public void drawEdges(Grafo D, boolean orient){
  for(Link l : D.links){
...
public void draw(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "approx" };
    if (passedArgs != null) {
